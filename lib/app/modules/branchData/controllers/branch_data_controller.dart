...
import 'package:gas_bank_operator/app/modules/branchData/model_branch.dart';
...
class BranchDataController extends GetxController {
  ...
  final instance = Get.put(HomeController());
    ...
    if (branchNameController.text == "") {
      ...
      if (response.statusCode == 200) {
        ...
        Fluttertoast.showToast(
            ...
            fontSize: 16.0);
        getBranches().whenComplete(() => homeController.fetchBranches().whenComplete(() => isLoading.value = false));
        clearAll();
