...
import 'package:gas_bank_operator/app/modules/home/controllers/home_controller.dart';
...
class BranchDataView extends GetView<BranchDataController> {
  ...
  void updateBranch(BuildContext context, int id, String branchName,
      String noOfMachines, String floor) {
    AlertDialog alertDialog = AlertDialog(
        actions: [
          ElevatedButton(
              onPressed: () {
