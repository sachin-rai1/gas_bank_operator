...
class GasMonitorController extends GetxController {
  ...
  Future<void> addGasMonitorData() async {
    fetchGasMonitorDataForCrud(selectedBranchId.value, selectedGasId.value).whenComplete(() async {
      ...
      else if(standbyGasMonitorData.isEmpty && selectedGasStatus.value == 4 ){
        Fluttertoast.showToast(
      ...
      else if(onlineGasMonitorData.isNotEmpty && selectedGasStatus.value == 2){
        Fluttertoast.showToast(
            msg: "You already have 1 online bottle , Please edit or delete the bottle first",
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.CENTER,
            timeInSecForIosWeb: 1,
            backgroundColor: Colors.red,
      ...
      else if(standbyGasMonitorData.isNotEmpty && selectedGasStatus.value == 3){
        Fluttertoast.showToast(
            msg: "You already have 1 stand by bottle , Please edit or delete the bottle first",
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.CENTER,
            timeInSecForIosWeb: 1,
            backgroundColor: Colors.red,
  ...
  Future<void> updateGasMonitorData(
    ...
    fetchGasMonitorDataForCrud(branchId, gasId).whenComplete(() async {
      ...
      if(onlineGasMonitorData.isNotEmpty && id != onlineGasMonitorData[0].gasMonitorId && selectedGasStatus.value == 2){
        Fluttertoast.showToast(
      ...
      else if(standbyGasMonitorData.isNotEmpty && selectedGasStatus.value == 3 && id != standbyGasMonitorData[0].gasMonitorId ){
        Fluttertoast.showToast(
  ...
  Future<void> deleteGasMonitorData(int id , int branchId , int gasId , int gasStatus , DateTime dueDate) async {

  fetchGasMonitorDataForCrud(branchId , gasId).whenComplete(() async {
    if(standbyGasMonitorData.isNotEmpty &&  gasStatus == 2 && dueDate.compareTo(DateTime.now().add(const Duration(days: 1))) >= 0){
      Fluttertoast.showToast(
